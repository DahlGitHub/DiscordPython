...
class ButtonPaginator(Generic[PageT_co], discord.ui.View):
    message: Optional[Union[discord.Message, discord.InteractionMessage, discord.WebhookMessage]] = None
    ...
    async def get_page_kwargs(
        ...
        elif hasattr(formatted_page, "embed") and isinstance(formatted_page.embed, discord.Embed):
            self._page_kwargs["embeds"].append(formatted_page.embed)
        else:
    ...
    async def start(
        ...
        if isinstance(obj, discord.Interaction):
            if obj.response.is_done():
                ...
                if callback and isinstance(callback.resource, discord.InteractionMessage):
